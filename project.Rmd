...
### Methodology
Memory game was thought to be use on smartphones. Then each game has only 24 cards (12 pairs) arranged in a grid of six rows and four columns. At the beginning of the game, the player has 5 seconds to see all the cards and memorize their locations. Later every time a pair is open user has 1 second to see and continue.

Once the game is over, a record is create with all the moves made for the player. Each movement is made of 8 variables, image, coordinates ( x, y ), and the timestamp to mark the moment when the cards were open. This data is usefull for analyzing the game. The coordinates, for example, will allow you to observe if there are points on the screen where the players concentrate more attention.
